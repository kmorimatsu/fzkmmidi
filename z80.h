...
/*
	T cycle counting is not used for Fuzix.
...
#define setT4() while(0)
#define setT5() while(0)
#define setT6() while(0)
#define setT7() while(0)
#define setT8() while(0)
#define setT9() while(0)
#define setT10() while(0)
#define setT11() while(0)
#define setT12() while(0)
#define setT13() while(0)
#define setT14() while(0)
#define setT15() while(0)
#define setT16() while(0)
#define setT17() while(0)
#define setT19() while(0)
#define setT20() while(0)
#define setT21() while(0)
#define setT23() while(0)
#define setT4_5() while(0)
#define setT4_7() while(0)
#define setT6_5() while(0)
#define setT10_11() while(0)
#define setT11_10() while(0)
#define setT19_18() while(0)
...
#define loadR(x) (((UINT8*)(&z80IR))[0]=(UINT8)((x)&0x7f))
