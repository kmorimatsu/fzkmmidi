...
void codeEDA0(){
	//LDI
		...
		PRECODEEDA0
	#endif
	//(DE) ・ｽ・ｽ (HL), DE ・ｽ・ｽ DE + 1, HL ・ｽ・ｽ HL + 1, BC ・ｽ・ｽ BC -1
	setT16();
...
void codeEDA2(){
	//INI
		...
		PRECODEEDA2
	#endif
	//(HL) ・ｽ・ｽ (C), B ・ｽ・ｽ B -1, HL ・ｽ・ｽ HL + 1
	setT16();
...
void codeEDA3(){
	//OUTI
		...
		PRECODEEDA3
	#endif
	//(C) ・ｽ・ｽ (HL), B ・ｽ・ｽ B -1, HL ・ｽ・ｽ HL + 1
	setT16();
...
void codeEDB0(){
	//LDIR
		...
		PRECODEEDB0
	#endif
	//(DE) ・ｽ・ｽ (HL), DE ・ｽ・ｽ DE + 1, HL ・ｽ・ｽ HL + 1, BC F? BC -1
	if (regBC==1) {
		setT16();
	} else {
		setT21();
